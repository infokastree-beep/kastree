...
class S3ObjectStorage:
    ...
    def put_export(
        ...
        *,
        ...
        # NOT schedule object deletion. Tagging= is required so the bucket
        # lifecycle filter in configure_s3_lifecycle.py can match this object.
        # Actual deletion = bucket put_bucket_lifecycle_configuration (one-time
        # infra); verify with get-bucket-lifecycle-configuration on deploy.
